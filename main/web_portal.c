...
"          if (st.internet === 'online') {"
"            net = '🌐 Internet: <b style=\"color:#276749;\">ONLINE (' + st.internet_info + ')</b><br><small style=\"color:#718096; margin-top:6px; display:block;\">SoftAP sẽ tự động tắt sau 5s để chuyển sang chế độ hoạt động.</small>';"
"            clearInterval(pollId);"
"          } else if (st.internet === 'offline') {"
"            net = '⚠️ <b style=\"color:#9b2c2c;\">Chưa có Internet (Không ping được 1.1.1.1 & 8.8.8.8)</b>';"
"          }"
